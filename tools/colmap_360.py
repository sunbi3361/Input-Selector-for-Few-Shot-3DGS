...
#     pipeline(scene, base_path = '/data01/sbin/workspace/ACV_25_spring/FSGS/dataset/mipnerf360_v2/', n_views = 24)  # please use absolute path!
for scene in ['bicycle']:
    pipeline(scene, base_path = '/data01/sbin/workspace/ACV_25_spring/FSGS/dataset/360_v2/', n_views = 24)  # please use absolute path!
